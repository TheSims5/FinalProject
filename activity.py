...
class Activity(object):
    ...
    def __init__(self, start_time=0, end_time=0, dest_intitution_int=0, communities=[]):
        self.start_time = start_time
        self.end_time = end_time
        self.dest_intitution_int = dest_intitution_int
        self.communities = communities

    def display(self):
        print("start_time: " + str(self.start_time))
        print("end_time: " + str(self.end_time))
        print("destination institution: " + str(self.dest_intitution_int))
